...
const actorTypeConfig: Record<ActivityActorType, { label: string; color: string; bgColor: string }> = {
  agent: { label: 'Agent', color: 'text-blue-700', bgColor: 'bg-blue-50' },
  candidate: { label: 'Kandidaat', color: 'text-green-700', bgColor: 'bg-green-50' },
  recruiter: { label: 'Recruiter', color: 'text-amber-700', bgColor: 'bg-amber-50' },
  system: { label: 'Systeem', color: 'text-gray-700', bgColor: 'bg-gray-50' },
};
  ...
  return (
    <>
      <PageLayout>
        <PageLayoutHeader
          title="Activiteiten"
          description="Alle agent activiteiten en events in het systeem"
        />
        <PageLayoutContent>
