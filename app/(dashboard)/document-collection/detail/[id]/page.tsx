...
import { ArrowLeft, Pencil, Smartphone, LayoutDashboard, Loader2, Sparkles, Info } from 'lucide-react';
...
export default function DocumentCollectionEditPage({
  ...
  const handleAutoGenerate = async () => {
    ...
    // For now, just reset to dummy documents
    setDocuments(DUMMY_DOCUMENTS);
    setIsGenerating(false);
    console.log('Auto-generating document requirements...');
  };
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-gray-500">Documentcollectie laden...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-white border-b px-6 py-4 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {isGenerating ? 'Genereren...' : 'Auto genereren'}
          </button>
