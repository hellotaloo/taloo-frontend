...
function OntologyNode({ data }: { data: OntologyNodeData }) {
  ...
  if (isRoot) {
    return (
      <div
        className={`w-[180px] px-5 py-4 rounded-xl bg-brand-dark-blue shadow-lg hover:shadow-xl transition-all duration-200 ${opacityClass}`}
      >
  ...
  return (
    <div
      className={`w-[180px] px-4 py-3 rounded-xl bg-white border-2 shadow-sm hover:shadow-lg transition-all duration-200 cursor-pointer ${opacityClass}`}
